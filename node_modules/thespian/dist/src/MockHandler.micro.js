...
describe('MockHandler()', () => {
    it("Call on an unknown method", () => {
        ...
        assertThat_1.assertThat(() => handler.get(undefined, methodName, undefined)(12)).throwsError(`{
  ...
  mockCall: thespian.method()
    ...
    describe('method:', () => {
        it("Call known method with a single MockedCall, with undefined result", () => {
            ...
            assertThat_1.assertThat(fn(5)).is(5);
            assertThat_1.assertThat(fixture.successes()).is([{
                    call: SuccessfulCall_1.createPseudoCall("thespian.method", [5]),
        ...
        it("Call known method with a single MockedCall, with specified result", () => {
            ...
            fixture.makeMock(methodName, [1])
                .returns(() => 456);
            const fn = fixture.getMock(methodName);
            assertThat_1.assertThat(fn(1)).is(456);
            assertThat_1.assertThat(fixture.successes()).is([{
                    call: SuccessfulCall_1.createPseudoCall("thespian.method", [1]),
        ...
        it("Call known method with a single MockedCall, but doesn't match", () => {
            ...
            fixture.makeMock(methodName, [1])
                .returns(() => 456);
            const fn = fixture.getMock(methodName);
            assertThat_1.assertThat(() => fn(2)).throws(match_1.match.any());
            assertThat_1.assertThat(fixture.successes()).is([]);
        });
        it("Call known method with a 2 MockedCall2, with one matching", () => {
            ...
            fixture.makeMock(methodName, [2, 3])
                .returns(() => 789);
            const fn = fixture.getMock(methodName);
            assertThat_1.assertThat(fn(1, 2)).is(456);
            assertThat_1.assertThat(fn(2, 3)).is(789);
            assertThat_1.assertThat(fixture.successes()).is([
                { call: SuccessfulCall_1.createPseudoCall("thespian.method", [1, 2]), returnValue: 456, expectedTimes: 1 },
                { call: SuccessfulCall_1.createPseudoCall("thespian.method", [2, 3]), returnValue: 789, expectedTimes: 1 }
            ]);
        });
    });
    describe('function:', () => {
        it("Call known function with no match", () => {
            ...
            assertThat_1.assertThat(() => fn("a")).throws(match_1.match.any());
            assertThat_1.assertThat(fixture.successes()).is([]);
        });
    ...
    it("symbolForMockToString", () => {
        ...
        assertThat_1.assertThat(fn()).is("thespian");
    });
});
