...
describe("Mocked:", () => {
    describe("setUp():", () => {
        it("Expects a lambda", () => {
            ...
            mismatched_1.assertThat(() => fixture.mockUnderTest.setup(4))
        ...
        it("Is a method", () => {
            ...
            const expected = {
                ...
                expectedTimesInProgress: { expected: 1, complexity: mismatched_1.match.any() },
                expectedTimes: { expected: 1, complexity: mismatched_1.match.any() },
                actualTimes: 0,
                expectedArgs: { matchers: [], complexity: mismatched_1.match.any() },
                returnFn: mismatched_1.match.any()
            };
            mockHandler
                .setup(m => m.addCall(expected))
                .returnsVoid();
            mismatched_1.assertThat(mockUnderTest.setup(j => j.f())).is(expected);
        });
        it("Is a function", () => {
            const fixture = new MockFixture_1.MockFixture();
            ...
            mockHandler
                .setup(m => m.addCall(expected))
                .returnsVoid();
            mismatched_1.assertThat(mockUnderTest.setup(f => f())).is(expected);
        });
        it("Is a property", () => {
            const fixture = new MockFixture_1.MockFixture();
            const { mockUnderTest, mockHandler } = fixture;
            const expected = {
                ...
                expectedTimesInProgress: { expected: 1, complexity: mismatched_1.match.any() },
                expectedTimes: { expected: 1, complexity: mismatched_1.match.any() },
                actualTimes: 0, expectedArgs: { matchers: [], complexity: mismatched_1.match.any() },
                returnFn: mismatched_1.match.any()
            };
            mockHandler
                .setup(m => m.addCall(expected))
    ...
    it("describeMocks()", () => {
        ...
        mockHandler
            ...
            .returns(() => ["bla bla"]);
        mismatched_1.assertThat(mockUnderTest.describeMocks()).is(["bla bla"]);
        fixture.verify();
    });
});
