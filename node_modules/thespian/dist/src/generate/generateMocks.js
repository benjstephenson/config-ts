    ...
    switch (compiled.type) {
        case Compiled_1.CompiledType.ClassType:
            ...
            if (someMocks) {
                ...
                results.push(fillTemplate_1.fillTemplate(template, { name: className, lets, initialisers }));
            }
            break;
        ...
        case Compiled_1.CompiledType.FunctionType:
            ...
            if (someMocks) {
                results.push(fillTemplate_1.fillTemplate(template, { name: compiled.name, lets, initialisers }));
            }
            break;
    }
};
