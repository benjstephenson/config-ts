...
describe("arrayDiff", () => {
    it("is empty", () => {
        const result = arrayDiff_1.arrayDiff([], []);
        assertThat_1.assertThat(result).is([]);
    });
    it("is same", () => {
        const matcher = match_1.match.isEquals(1);
        const actual = 1;
        const result = arrayDiff_1.arrayDiff([matcher], [actual]);
        assertThat_1.assertThat(result).is([{ actual: prelude_ts_1.Option.of(actual), actualIndex: 0, matcher: isMatcher(matcher) }]);
    });
    it("is same with undefined", () => {
        assertThat_1.assertThat(new prelude_ts_1.Some(undefined).getOrThrow()).is(undefined);
        const matcher = match_1.match.isEquals(undefined);
        const actual = undefined;
        const result = arrayDiff_1.arrayDiff([matcher], [actual]);
        assertThat_1.assertThat(result).is([{ actual: new prelude_ts_1.Some(actual), actualIndex: 0, matcher: isMatcher(matcher) }]);
    });
    it("is same with null", () => {
        assertThat_1.assertThat(new prelude_ts_1.Some(null).getOrThrow()).is(null);
    ...
    it("expected 1 but there were none", () => {
        const matcher = match_1.match.isEquals(1);
        const result = arrayDiff_1.arrayDiff([matcher], []);
        assertThat_1.assertThat(result).is([{ actual: prelude_ts_1.Option.none(), matcher: isMatcher(matcher) }]);
    });
    it("expected none but there was one", () => {
        const actual = 1;
        const result = arrayDiff_1.arrayDiff([], [actual]);
        assertThat_1.assertThat(result).is([{ actual: prelude_ts_1.Option.of(actual), actualIndex: 0, matcher: prelude_ts_1.Option.none() }]);
    });
    ...
    it("expected a 1 but there was an undefined", () => {
        ...
        const actual = undefined;
        const result = arrayDiff_1.arrayDiff([matcher], [actual]);
        assertThat_1.assertThat(result).is([{ actual: new prelude_ts_1.Some(actual), actualIndex: 0, matcher: prelude_ts_1.Option.none() },
            { actual: prelude_ts_1.Option.none(), matcher: isMatcher(matcher) }]);
    });
    ...
    it("expected 1, 2 but there was a 1", () => {
        ...
        const actual = 1;
        const result = arrayDiff_1.arrayDiff([matcher1, matcher2], [actual]);
        assertThat_1.assertThat(result).is([
    ...
    it("expected 1, 2 but there was a 1, 3", () => {
        ...
        const actual1 = 1;
        const actual2 = 3;
        const result = arrayDiff_1.arrayDiff([matcher1, matcher2], [actual1, actual2]);
        assertThat_1.assertThat(result).is([
    ...
    it("expected a [0, 1] but there was a [0, 2]", () => {
        ...
        const actual = [0, 2];
        const result = arrayDiff_1.arrayDiff([matcher], actual);
        assertThat_1.assertThat(result).is([{ actual: prelude_ts_1.Option.of(0), actualIndex: 0, matcher: prelude_ts_1.Option.none() },
    ...
    it("expected a single key match that otherwise fails, along with unexpected before and after", () => {
        ...
        const result = arrayDiff_1.arrayDiff([matcher], [10, actual2, 20]);
        assertThat_1.assertThat(result).is([
    ...
    it("expected a single key match that otherwise fails, along with expected before and after", () => {
        ...
        const actual = { id: 1, f: 2 };
        const result = arrayDiff_1.arrayDiff([matcher1, matcher2, matcher3], [actual]);
        assertThat_1.assertThat(result).is([
            { actual: prelude_ts_1.Option.none(), matcher: isMatcher(matcher1) },
            { actual: prelude_ts_1.Option.of(actual), actualIndex: 0, matcher: isMatcher(matcher2) },
    ...
    it("expected a single key match that otherwise fails, along with mix before and after", () => {
        ...
        const matcher3 = match_1.match.isEquals(40);
        const actual = { id: 1, f: 2 };
        const result = arrayDiff_1.arrayDiff([matcherA, matcher1, matcherB, matcher2, matcher3], [actual]);
        assertThat_1.assertThat(result).is([
