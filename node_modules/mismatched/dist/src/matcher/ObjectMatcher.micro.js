...
describe("obj.match:", () => {
    describe("assertThat():", () => {
        describe('matches', () => {
            it('with implicit matchers', () => {
                ...
                assertThat_1.assertThat(actual).is({ f: 2, g: 3 });
            });
            it('explicit matcher object', () => {
                const actual = { f: 2, g: 3 };
                assertThat_1.assertThat(actual).is(match_1.match.obj.match({ f: 2, g: 3 }));
            });
            it('literal object', () => {
                const actual = { f: 2, g: 3 };
                assertThat_1.assertThat(actual).is(actual);
                assertThat_1.assertThat({ f: 3, g: { e: 4 } }).is({ f: 3, g: { e: 4 } });
            });
            it('literal object with a field that is undefined', () => {
                assertThat_1.assertThat({ f: undefined }).is({ f: undefined });
                assertThat_1.assertThat({ f: undefined }).is({});
            });
            it('with embedded matchers', () => {
                assertThat_1.assertThat({ f: 2, g: 3 })
        ...
        describe('does not match actual as:', () => {
            describe('different:', () => {
                it('different field value', () => {
                    const actual = { f: 3 };
                    assertThat_1.assertThat(actual).failsWith({ f: 2 }, { f: { [MatchResult_1.MatchResult.was]: 3, [MatchResult_1.MatchResult.expected]: 2 } });
                });
                ...
                it('different sub-field value', () => {
                    ...
                    assertThat_1.assertThat(actual).failsWith({ f: 2, g: { h: 2 } }, { f: 2, g: { h: { [MatchResult_1.MatchResult.was]: 3, [MatchResult_1.MatchResult.expected]: 2 } } });
                });
                ...
                it('different sub-field value #2', () => {
                    ...
                    assertThat_1.assertThat(actual).failsWith({ g: { h: 2, i: 5 } }, {
                        g: {
                ...
                it('different field value, involving a customer renderer and matcher', () => {
                    ...
                    assertThat_1.assertThat(actual).failsWithRendering(expect, `{d: {${MatchResult_1.MatchResult.was}: Hide(12), ${MatchResult_1.MatchResult.expected}: Hide(0)}}`);
                });
            });
            describe('missing:', () => {
                it('1. missing field', () => {
                    const actual = { f: 3 };
                    assertThat_1.assertThat(actual).failsWith({ f: 3, g: 4 }, { f: 3, g: { [MatchResult_1.MatchResult.expected]: 4 } });
                });
                ...
                it('2. missing field, when no actual fields', () => {
                    const actual = {};
                    assertThat_1.assertThat(actual).failsWith({ g: 3 }, { g: { [MatchResult_1.MatchResult.expected]: 3 } });
                });
                it('3. missing sub-field', () => {
                    const actual = { f: 2, g: { h: 3, i: 7 } };
                    assertThat_1.assertThat(actual).failsWith({ f: 3, g: { h: 3, i: 7, j: 4 } }, {
                ...
                it('4. missing sub-field, with no data inside it', () => {
                    const actual = { g: {} };
                    assertThat_1.assertThat(actual).failsWith({ g: { i: 7 } }, { g: { i: { [MatchResult_1.MatchResult.expected]: 7 } } });
                });
            });
            describe('extra:', () => {
                it('extra field', () => {
                    const actual = { f: 2, g: 3 };
                    assertThat_1.assertThat(actual).failsWith({ f: 2 }, { f: 2, [MatchResult_1.MatchResult.unexpected]: { g: 3 } });
                });
                ...
                it('extra field when expecting no fields', () => {
                    const actual = { f: 2, g: 3 };
                    assertThat_1.assertThat(actual).failsWith({}, { [MatchResult_1.MatchResult.unexpected]: { f: 2, g: 3 } });
                });
            });
            it("Needs an actual object", () => {
                assertThat_1.assertThat(undefined).failsWith({ f: 2 }, { [MatchResult_1.MatchResult.expected]: { f: 2 } });
                assertThat_1.assertThat(2).failsWith({ f: 2 }, { [MatchResult_1.MatchResult.was]: 2, [MatchResult_1.MatchResult.expected]: { f: 2 } });
            });
            it("has a missing key", () => {
                const actual = { f: 3, g: 4 };
                assertThat_1.assertThat(actual).failsWith({ f: match_1.match.obj.key(2), g: 5 }, {
            ...
            it("has two missing keys", () => {
                ...
                assertThat_1.assertThat(actual).failsWith(expected, {
                    f: { [MatchResult_1.MatchResult.was]: 3, [MatchResult_1.MatchResult.expected]: 2 },
                    g: { [MatchResult_1.MatchResult.was]: 4, [MatchResult_1.MatchResult.expected]: 5 }
                });
            });
    ...
    describe("validateThat():", () => {
        it("succeeds", () => {
            ...
            const validationResult = validateThat_1.validateThat({ f: 2, g: true }).satisfies(expected);
            assertThat_1.assertThat(validationResult.passed()).is(true);
        });
        it("fails on one field", () => {
            const expected = { f: match_1.match.ofType.number(), g: match_1.match.ofType.boolean() };
            const validationResult = validateThat_1.validateThat({ f: "2", g: true }).satisfies(expected);
            assertThat_1.assertThat(validationResult.passed()).is(false);
            assertThat_1.assertThat(validationResult.errors).is([
                `{"actual.f": "2", expected: "ofType.number"}`
            ]);
        });
        it("fails", () => {
            const expected = { f: match_1.match.ofType.number(), g: match_1.match.ofType.boolean() };
            const validationResult = validateThat_1.validateThat({ f: "2", g: 3 }).satisfies(expected);
            assertThat_1.assertThat(validationResult.passed()).is(false);
            assertThat_1.assertThat(validationResult.errors).is([
                `{"actual.f": "2", expected: "ofType.number"}`,
        ...
        it("fails on one field with optionalNull()", () => {
            ...
            const validationResult = validateThat_1.validateThat({ f: { h: { j: "2" }, i: 4 }, g: true }).satisfies(expected);
            assertThat_1.assertThat(validationResult.passed()).is(false);
            assertThat_1.assertThat(validationResult.errors).is([
        ...
        it("has a missing key", () => {
            const validationResult = validateThat_1.validateThat({ f: "2", g: 3 }).satisfies({
