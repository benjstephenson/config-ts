...
describe("AnyOfMatcher:", () => {
    describe("assertThat():", () => {
        it("Matches", () => {
            ...
            assertThat_1.assertThat({ a: 2 }).isAnyOf([match_1.match.instanceOf(Object)]);
            assertThat_1.assertThat({ a: 2 }).isAnyOf([match_1.match.instanceOf(Object)]);
        });
        it("Mismatches", () => {
        ...
        it("Mismatches with multiple anyOf", () => {
            assertThat_1.assertThat("ab").failsWith(match_1.match.anyOf([match_1.match.instanceOf(Date), match_1.match.instanceOf(Date)]), match_1.match.any());
            assertThat_1.assertThat({ f: "ab", g: 3 })
        ...
        it("Optimise away with a single matcher inside", () => {
            ...
            assertThat_1.assertThat(match_1.match.anyOf([whatever])).is(match_1.match.itIs(whatever));
        });
    });
    describe("validateThat():", () => {
        ...
        it("fails and just mentions the single match that was close", () => {
            ...
            const validation = validateThat_1.validateThat({ f: 3 }).satisfies(expected);
            assertThat_1.assertThat(validation.passed()).is(false);
            assertThat_1.assertThat(validation.errors).is([
        ...
        it("Just mentions the failures to match within the single key match", () => {
            ...
            const validation = validateThat_1.validateThat(actual).satisfies(match_1.match.anyOf([matchTypeA, matchTypeB]));
            assertThat_1.assertThat(validation.passed()).is(false);
            assertThat_1.assertThat(validation.errors).is([
        ...
        it("Just mentions the failures to match within the single key match nested", () => {
            ...
            const validation = validateThat_1.validateThat(actual).satisfies({
                x: match_1.match.any(),
        ...
        it("fails with no key", () => {
            ...
            const validation = validateThat_1.validateThat({ type: 'a', f: 4 }).satisfies(expected);
            assertThat_1.assertThat(validation.passed()).is(false);
            assertThat_1.assertThat(validation.errors).is([
