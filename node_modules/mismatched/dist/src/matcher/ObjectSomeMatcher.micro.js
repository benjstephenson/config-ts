...
describe("obj.some:", () => {
    describe("assertThat():", () => {
        describe('matches', () => {
            it('with explicit field matchers', () => {
                ...
                assertThat_1.assertThat(actual).is(match_1.match.obj.has({ f: 2, g: 3 }));
            });
            it('literal object', () => {
                const actual = { f: 2, g: 3, h: 4 };
                assertThat_1.assertThat(actual).is(match_1.match.obj.has({ f: 2, g: 3 }));
        ...
        describe('does not match actual that is:', () => {
            it('an object', () => {
                ...
                assertThat_1.assertThat(actual).failsWith(expected, { f: { [MatchResult_1.MatchResult.was]: 2, [MatchResult_1.MatchResult.expected]: 3 } });
            });
            it('not an object', () => {
                const actual = 3;
                const expected = match_1.match.obj.has({ f: 3 });
                assertThat_1.assertThat(actual).failsWith(expected, { [MatchResult_1.MatchResult.was]: 3, [MatchResult_1.MatchResult.expected]: { "obj.has": { f: 3 } } });
            });
            it('undefined', () => {
                const actual = undefined;
                const expected = match_1.match.obj.has({ f: 3 });
                assertThat_1.assertThat(actual).failsWith(expected, { [MatchResult_1.MatchResult.expected]: { "obj.has": { f: 3 } } });
            });
        });
    });
    describe("validateThat():", () => {
        ...
        it("succeeds", () => {
            const validation = validateThat_1.validateThat({ f: 2, g: true, h: 45 }).satisfies(expected);
            assertThat_1.assertThat(validation.passed()).is(true);
        });
        it("fails wrong types", () => {
            const validation = validateThat_1.validateThat({ f: "2", g: 3, h: 45 }).satisfies(expected);
        ...
        it("fails to match", () => {
            const validation = validateThat_1.validateThat({ f: "2" }).satisfies({ f: 3 });
            assertThat_1.assertThat(validation.passed()).is(false);
            assertThat_1.assertThat(validation.errors).is([
