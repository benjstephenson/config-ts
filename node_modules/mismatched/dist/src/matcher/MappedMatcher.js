...
class MappedMatcher extends DiffMatcher_1.DiffMatcher {
    ...
    static make(map, matcher, description) {
        return new MappedMatcher(map, matchMaker_1.matchMaker(matcher), description);
    }
