...
describe("set:", () => {
    describe("set.match:", () => {
        describe("assertThat():", () => {
            it('matches', () => {
                assertThat_1.assertThat(new Set([1, 2, 3])).is(match_1.match.aSet.match(new Set([1, 2, 3])));
                assertThat_1.assertThat([1, 2, 3]).is(match_1.match.aSet.match([2, 1, 3]));
                assertThat_1.assertThat(new Set([1, 2, 3])).is(match_1.match.aSet.match([3, 2, 1]));
                assertThat_1.assertThat([[1, 1], [2, 2], [3, 3]]).is(match_1.match.aSet.match([[1, 1], [2, 2], [3, 3]]));
            });
            it('matches right', () => {
                assertThat_1.assertThat(new Set([1, 2, 3])).is(match_1.match.aSet.match(new Set([1, 2, match_1.match.any()])));
                assertThat_1.assertThat([1, 2, 3]).is(match_1.match.aSet.match([2, 1, match_1.match.any()]));
            ...
            it('matches with nested has', () => {
                assertThat_1.assertThat([{ s: true, extra: 'junk' }, { s: undefined, extra: 'extra' }]).is(match_1.match.aSet.match([
            ...
            it('does not match: too many', () => {
                ...
                assertThat_1.assertThat(actual).failsWith(match_1.match.aSet.match(new Set([1, 2])), [1, 2, { [MatchResult_1.MatchResult.unexpected]: 3 }]);
            });
            it('does not match: too few', () => {
                const actual = new Set([1, 2]);
                assertThat_1.assertThat(actual).failsWith(match_1.match.aSet.match(new Set([1, 2, 3])), [1, 2, { [MatchResult_1.MatchResult.expected]: 3 }]);
            });
            it('does not match: values mismatch', () => {
                const actual = new Set([1, 2, 3]);
                const expected = new Set([1, 2, 4]);
                assertThat_1.assertThat(actual).failsWith(match_1.match.aSet.match(expected), [1, 2, { [MatchResult_1.MatchResult.was]: 3, [MatchResult_1.MatchResult.expected]: 4 }
                ]);
            });
            it('matches literally nested', () => {
                const actual = new Set([1, 2, new Set([3, [5]])]);
                assertThat_1.assertThat(actual).is(new Set([1, 2, new Set([3, [5]])]));
            });
            it('does not match literally nested', () => {
                const actual = new Set([1, 2, new Set([3, [5]])]);
                const expected = new Set([1, 2, new Set([44, [5]])]);
                assertThat_1.assertThat(actual).failsWith(expected, [1, 2, [{ [MatchResult_1.MatchResult.was]: 3, [MatchResult_1.MatchResult.expected]: 44 }, [5]]]);
            });
            ...
            it('matches with bind, but only once elements in the actual and expected sets have been matched', () => {
                ...
                assertThat_1.assertThat(actual).is(expected);
            });
        });
        describe("validateThat():", () => {
            ...
            it("succeeds", () => {
                ...
                const validation = validateThat_1.validateThat(actual).satisfies(expected);
            ...
            it("succeeds with general matcher", () => {
                const actual = new Set([1, 2]);
                const validation = validateThat_1.validateThat(actual).satisfies(new Set([1, match_1.match.any()]));
                assertThat_1.assertThat(validation.errors).is([]);
                assertThat_1.assertThat(validation.passed()).is(true);
            });
    ...
    describe("set.subset:", () => {
        describe("assertThat():", () => {
            it('subset', () => {
                const actual = new Set([1, 2, 3]);
                assertThat_1.assertThat(actual).is(match_1.match.aSet.subset(new Set([1, 2, 3])));
                assertThat_1.assertThat(actual).is(match_1.match.aSet.subset(new Set([1, 2])));
            });
            it('does not match: values differ', () => {
                const actual = new Set([1, 2, 3]);
                assertThat_1.assertThat(actual).failsWith(match_1.match.aSet.subset(new Set([1, 4])), [1, { [MatchResult_1.MatchResult.was]: 2, [MatchResult_1.MatchResult.expected]: 4 }, 3]);
            });
            it('does not match: too many values expected', () => {
                const actual = new Set([1, 2, 3]);
                const expected = new Set([1, 2, 3, 4]);
                assertThat_1.assertThat(actual).failsWith(match_1.match.aSet.subset(expected), [1, 2, 3, { [MatchResult_1.MatchResult.expected]: 4 }]);
            });
        });
        describe("validateThat():", () => {
            const isNumber = match_1.match.ofType.number();
            ...
            it("succeeds", () => {
                const actual = new Set([1, new Set([4])]);
                const validation = validateThat_1.validateThat(actual).satisfies(match_1.match.aSet.subset(expected));
                assertThat_1.assertThat(validation.errors).is([]);
                assertThat_1.assertThat(validation.passed()).is(true);
            });
            it("fails as incorrect set", () => {
