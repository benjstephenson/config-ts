...
describe("array.match:", () => {
    describe("assertThat():", () => {
        it('matches with undefined and null', () => {
            ...
            assertThat_1.assertThat(actual).is([2, undefined, null]);
        });
        describe("Primitive values only", () => {
            it('matches', () => {
                const actual = [2, 2, 2];
                assertThat_1.assertThat(actual).is([2, 2, 2]);
            });
            it('Actual longer: unexpected', () => {
                ...
                assertThat_1.assertThat(result.matchRate).is(0.5);
            });
            it('Expected longer: expected', () => {
                const actual = ["c", "d"];
                const expected = ["a", "b", "c", "d"];
                assertThat_1.assertThat(actual).failsWith(expected, [{ [MatchResult_1.MatchResult.expected]: "a" }, { [MatchResult_1.MatchResult.expected]: "b" }, "c", "d"]);
                const matcher = ArrayMatcher_1.ArrayMatcher.make(expected);
                const result = matcher.matches(actual);
                assertThat_1.assertThat(result.matchRate).is(0.5);
            });
            it('Various differences, including in order: unexpected and expected', () => {
                ...
                const matcher = ArrayMatcher_1.ArrayMatcher.make(expected);
                const result = matcher.matches(actual);
                assertThat_1.assertThat(result.matchRate).is(0.4);
            });
        ...
        it('Other differences', () => {
            assertThat_1.assertThat([{ b: "b" }, ["x"], "y"]).failsWith([{ a: "a" }, { b: "b" }, "c", ["x"]], [{ [MatchResult_1.MatchResult.expected]: { a: "a" } }, { b: "b" }, { [MatchResult_1.MatchResult.expected]: "c" }, ["x"],
                { [MatchResult_1.MatchResult.unexpected]: "y" }]);
        });
        it('matches the best first (sub)', () => {
            assertThat_1.assertThat([{ a: 11, b: [0] }]).failsWith([{ a: 11, b: [1] }], [{ a: 11, b: [{ [MatchResult_1.MatchResult.unexpected]: 0 }, { [MatchResult_1.MatchResult.expected]: 1 }] }]);
        });
        it('does not match: values mismatch', () => {
            const actual = ["a", "b"];
            const expected = ["a", "c"];
            assertThat_1.assertThat(actual).failsWith(expected, ["a", { [MatchResult_1.MatchResult.unexpected]: "b" }, { [MatchResult_1.MatchResult.expected]: "c" }]);
        });
        ...
        it('matches literally nested', () => {
            ...
            assertThat_1.assertThat(actual).is([2, 2, [3, [4]]]);
        });
        it('does not match literally nested', () => {
            const actual = [1, 2, [3, [5]]];
            assertThat_1.assertThat(actual).failsWith([2, 2, [3, [4, 6]]], [
            ...
            assertThat_1.assertThat(actual).failsWith([1, 2, [3, [6]]], [1, 2, [3, { [MatchResult_1.MatchResult.unexpected]: [5] }, { [MatchResult_1.MatchResult.expected]: [6] }]]);
        });
        ...
        it('does not match literally nested - wrong type', () => {
            ...
            assertThat_1.assertThat(actual).failsWith(expected, [1, 2, [3, { [MatchResult_1.MatchResult.unexpected]: [5] }, { [MatchResult_1.MatchResult.expected]: "a" }]]);
            assertThat_1.assertThat(expected).failsWith(actual, [1, 2, [3, { [MatchResult_1.MatchResult.unexpected]: "a" }, { [MatchResult_1.MatchResult.expected]: [5] }]]);
        });
        it("uses match.bind() to check for two values the same", () => {
            ...
            assertThat_1.assertThat(value).is({
                colours: [
                    bindColour,
                    bindColour
                ]
    ...
    describe("validateThat():", () => {
        ...
        it("succeeds", () => {
            const validation = validateThat_1.validateThat([1, 2, [3, [4]]]).satisfies(expected);
            assertThat_1.assertThat(validation.passed()).is(true);
        });
        it("fails as element missing", () => {
            const expected = [isNumber];
            const validation = validateThat_1.validateThat([]).satisfies(expected);
        ...
        it("fails as element unexpectedly present", () => {
            const expected = [];
            const validation = validateThat_1.validateThat([1]).satisfies(expected);
            assertThat_1.assertThat(validation.passed()).is(false);
            assertThat_1.assertThat(validation.errors).is([
        ...
        it("fails as incorrect array, simple", () => {
            const expected = [isNumber];
            const validation = validateThat_1.validateThat(["s"]).satisfies(expected);
            assertThat_1.assertThat(validation.passed()).is(false);
            assertThat_1.assertThat(validation.errors).is([
        ...
        it("fails as incorrect array, less simple", () => {
            const validation = validateThat_1.validateThat([1, 2, [3, ["s"]]]).satisfies(expected);
            assertThat_1.assertThat(validation.passed()).is(false);
            assertThat_1.assertThat(validation.errors).is([
        ...
        it("fails as incorrect array with nested arrays", () => {
            const validation = validateThat_1.validateThat([undefined, 2, [3, ["s"]]]).satisfies(expected);
            assertThat_1.assertThat(validation.passed()).is(false);
            assertThat_1.assertThat(validation.errors).is([
