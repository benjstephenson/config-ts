...
class ErrorMatcher extends DiffMatcher_1.DiffMatcher {
    ...
    static make(matcher) {
        return new ErrorMatcher(matchMaker_1.matchMaker(matcher));
    }
}
