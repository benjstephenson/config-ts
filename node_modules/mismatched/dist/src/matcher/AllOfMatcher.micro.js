...
describe("AllOfMatcher:", () => {
    describe("assertThat():", () => {
        it("Matches", () => {
            assertThat_1.assertThat({ a: 2 }).isAllOf([match_1.match.instanceOf(Object)]);
            assertThat_1.assertThat(new Date()).isAllOf([match_1.match.instanceOf(Object), match_1.match.instanceOf(Date)]);
        });
        it("Mismatches", () => {
            assertThat_1.assertThat(3)
        ...
        it("Optimise with 1", () => {
            ...
            assertThat_1.assertThat(match_1.match.allOf([whatever])).is(match_1.match.itIs(whatever));
        });
        it("Optimise with 1 left after removing match.any()s", () => {
            const whatever = match_1.match.ofType.array();
            assertThat_1.assertThat(match_1.match.allOf([match_1.match.any(), whatever, match_1.match.any()])).is(match_1.match.itIs(whatever));
        });
    });
    describe("validateThat():", () => {
        it("succeeds", () => {
            const expected = [match_1.match.ofType.number()];
            const validation = validateThat_1.validateThat(3).satisfies(match_1.match.allOf(expected));
