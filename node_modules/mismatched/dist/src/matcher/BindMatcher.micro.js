...
describe("BindMatcher:", () => {
    describe("assertThat():", () => {
        describe("No nested matcher:", () => {
            it('matches exact same value:', () => {
                ...
                assertThat_1.assertThat(2).is(bind);
                assertThat_1.assertThat(2).is(bind);
            });
            it('fails to match on something different', () => {
                const bind = match_1.match.bind();
                assertThat_1.assertThat(2).is(bind);
                assertThat_1.assertThat(3).failsWith(bind, { [MatchResult_1.MatchResult.was]: 3, [MatchResult_1.MatchResult.expected]: 2 });
            });
            ...
            it("First bind builds a matcher that fails on matching", () => {
                ...
                const bindColour = match_1.match.bind();
                assertThat_1.assertThat(value).failsWith({
                    colours: [
                        bindColour,
                        bindColour,
                        bindColour
        ...
        describe("Nested matcher:", () => {
            it('Nested matcher fails', () => {
                ...
                assertThat_1.assertThat(2).failsWith(bind, { [MatchResult_1.MatchResult.was]: 2, [MatchResult_1.MatchResult.expected]: "ofType.string" });
            });
            it('matches exact same value:', () => {
    ...
    describe("validateThat():", () => {
        it("succeeds", () => {
            const bind = match_1.match.bind();
            const validation = validateThat_1.validateThat(2).satisfies(bind);
            assertThat_1.assertThat(validation.passed()).is(true);
        });
        it("fails", () => {
            const bind = match_1.match.bind();
            validateThat_1.validateThat(false).satisfies(bind);
            const validation = validateThat_1.validateThat(3).satisfies(bind);
