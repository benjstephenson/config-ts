...
class AnyOfMatcher extends DiffMatcher_1.DiffMatcher {
    constructor(matchers) {
        ...
        this.complexity = DiffMatcher_1.DiffMatcher.orComplexity(matchers);
    }
    static make(matchers) {
        if (matchers.length === 1) {
            return __1.matchMaker(matchers[0]);
        }
        return new AnyOfMatcher(matchers.map(m => __1.matchMaker(m)));
    }
