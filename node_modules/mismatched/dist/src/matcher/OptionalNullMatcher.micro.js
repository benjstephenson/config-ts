...
describe("OptionalNullMatcher:", () => {
    describe("assertThat():", () => {
        it("Matches", () => {
            assertThat_1.assertThat(3).is(match_1.match.optionalNull(3));
            assertThat_1.assertThat(undefined).is(match_1.match.optionalNull(3));
            assertThat_1.assertThat(null).is(match_1.match.optionalNull(3));
        });
        it("Mismatches", () => {
            assertThat_1.assertThat(4).failsWith(match_1.match.optionalNull(3), { [MatchResult_1.MatchResult.was]: 4, [MatchResult_1.MatchResult.expected]: 3 });
        });
    ...
    describe("validateThat():", () => {
        ...
        it("succeeds when null", () => {
            const validation = validateThat_1.validateThat({ f: null }).satisfies(expected);
            assertThat_1.assertThat(validation.passed()).is(true);
        });
        it("fails with wrong type", () => {
            const validation = validateThat_1.validateThat({ f: "wrong" }).satisfies(expected);
        ...
        it("Fails with lower-level diff", () => {
            const validation = validateThat_1.validateThat({ name: { title: 4 } }).satisfies({
