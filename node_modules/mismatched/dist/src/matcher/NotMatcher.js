...
class NotMatcher extends DiffMatcher_1.DiffMatcher {
    ...
    static make(matcher) {
        return new NotMatcher(matchMaker_1.matchMaker(matcher));
    }
}
