...
exports.numberMatcher = {
    ...
    lessEqual: (expected) => PredicateMatcher_1.PredicateMatcher.make(value => ofType_1.ofType.isNumber(value) && value <= expected, { "number.lessEqual": expected }),
    ...
    greaterEqual: (expected) => PredicateMatcher_1.PredicateMatcher.make(value => ofType_1.ofType.isNumber(value) && value >= expected, { "number.greaterEqual": expected }),
    withinDelta: (expected, delta) => PredicateMatcher_1.PredicateMatcher.make(value => ofType_1.ofType.isNumber(value) && ofType_1.ofType.isNumber(delta) && Math.abs(value - expected) <= delta, { "number.nearWithDelta": expected }),
};
