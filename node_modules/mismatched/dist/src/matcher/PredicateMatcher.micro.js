...
describe("PredicateMatcher:", () => {
    ...
    describe("assertThat():", () => {
        it("Matches", () => {
            assertThat_1.assertThat(5).is(matcher);
            assertThat_1.assertThat({ a: 2 }).is(match_1.match.predicate(v => v.a === 2));
        });
        it("Mismatches", () => {
    ...
    describe("validateThat():", () => {
        it("succeeds", () => {
            const validation = validateThat_1.validateThat(3).satisfies(matcher);
            assertThat_1.assertThat(validation.passed()).is(true);
        });
        it("fails", () => {
            const validation = validateThat_1.validateThat(-1).satisfies(matcher);
