...
describe("match.obj:", () => {
    describe("obj.match", () => {
        ...
        it('Embedded', () => {
            assertThat_1.assertThat(actual)
                ...
                name: "hamcrest",
                address: {
                    number: match_1.match.number.lessEqual(3),
                    street: "Oak St",
    ...
    describe("obj.has", () => {
        ...
        it('Explicit', () => {
            assertThat_1.assertThat(actual)
                .is(match_1.match.obj.has({ name: "hamcrest" }));
        });
        it('Embedded', () => {
            assertThat_1.assertThat(actual)
                .is(match_1.match.obj.has({
                address: {
                    number: 3,
                    street: "Oak St",
                    other: match_1.match.ofType.array()
...
//# sourceMappingURL=egMatchObject.micro.js.map