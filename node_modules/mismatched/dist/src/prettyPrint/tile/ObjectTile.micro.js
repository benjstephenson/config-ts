...
describe("ObjectTile", () => {
    it("No fields", () => {
        ...
        assertThat_1.assertThat(objectTile).is({ elements: [], stringLength: 2, complexity: 2 });
        assertThat_1.assertThat(Appender_1.Appender.composeLength(objectTile)).is(2);
    });
    it("One field", () => {
        ...
        assertThat_1.assertThat(Appender_1.Appender.composeLength(objectTile)).is(10);
        assertThat_1.assertThat(objectTile).is({ elements: [tile], stringLength: 10, complexity: 4 });
    });
    it("Three fields", () => {
        ...
        assertThat_1.assertThat(Appender_1.Appender.composeLength(objectTile)).is(30);
        assertThat_1.assertThat(objectTile).is({ elements: [tile1, tile2, tile3], stringLength: 30, complexity: 8 });
    });
});
