...
describe("ArrayTile", () => {
    it("Empty", () => {
        ...
        assertThat_1.assertThat(arrayTile).is({ elements: [], stringLength: 2, complexity: 2 });
        assertThat_1.assertThat(Appender_1.Appender.composeLength(arrayTile)).is(2);
    });
    it("One element", () => {
        const tile = new SimpleTile_1.SimpleTile("hello");
        const arrayTile = new ArrayTile_1.ArrayTile([tile]);
        assertThat_1.assertThat(Appender_1.Appender.composeLength(arrayTile)).is(7);
        assertThat_1.assertThat(arrayTile).is({ elements: [tile], stringLength: 7, complexity: 3 });
    });
    it("Three elements", () => {
        ...
        assertThat_1.assertThat(Appender_1.Appender.composeLength(arrayTile)).is(18);
        assertThat_1.assertThat(arrayTile).is({ elements: [tile1, tile2, tile3], stringLength: 18, complexity: 5 });
    });
});
