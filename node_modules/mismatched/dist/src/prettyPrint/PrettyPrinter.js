...
class PrettyPrinter {
    ...
    static isMock(value) {
        return ofType_1.ofType.isFunction(value) &&
            ...
            !util_1.isUndefined(value[PrettyPrinter.symbolForMockName]);
    }
    ...
    tile(context, value) {
        ...
        if (ofType_1.ofType.isArray(value)) {
            try {
                ...
                return new SimpleTile_1.SimpleTile(exports.exceptionMessage(e));
            }
        }
    ...
    tileObject(context, value) {
        try {
            ...
            return new SimpleTile_1.SimpleTile(exports.exceptionMessage(e)); // todo Change this to an auto-coloured Tile
        }
    }
}
